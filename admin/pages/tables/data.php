      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="./pages/tables/data.php" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="location" placeholder="Enter property address">
                    </div>
                    <!-- /.form-group -->
                  </div>
                  <!-- /.col -->
          ...
          <?php
             ...
             $db = $dbClass->connect();
             $ctrl = new Controller($db);
             $events = $ctrl->selectAll("products");
          ?>
          <div class="col-12">
            <div class="card">
              <div class="card-header">
